...
import IssuerAuthorModal from "../../../components/Modal/IssuerAuthorModal";

const IssuerAuthorsPage: NextPageWithLayout = () => {
...
IssuerAuthorsPage.getLayout = function getLayout(page: ReactElement) {
    return <AdminLayout>{page}</AdminLayout>;
};
export default IssuerAuthorsPage;
