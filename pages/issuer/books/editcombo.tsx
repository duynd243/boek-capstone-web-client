...
const IssuerEditBookComboPage: NextPageWithLayout<Props> = ({ data }) => {
...
IssuerEditBookComboPage.getLayout = function getLayout(page: ReactElement) {
  return <AdminLayout>{page}</AdminLayout>;
};
export default IssuerEditBookComboPage;
