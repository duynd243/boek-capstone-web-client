                            ...
                            <tr key={book?.id}>
                                ...
                                <TableData className="max-w-72">
                                    <div className="flex items-center gap-4">
                                        ...
                                        />
                                        <div
                                            className="max-w-[15rem] overflow-hidden text-ellipsis text-sm font-medium text-gray-900">
                                            {book.name}
                                        </div>
                                    </div>
                                </TableData>
                                    ...
                                    {!book?.isSeries ? <div className="flex items-center">
                                        <div className="h-10 w-10 flex-shrink-0">
                                            <Image
                                                ...
                                                src={book?.publisher?.imageUrl || getAvatarFromName(book?.publisher?.name)}
                                                alt=""
                                            />
                                        </div>
                                        <div className="ml-4">
