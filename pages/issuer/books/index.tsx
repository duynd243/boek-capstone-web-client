        ...
        <Fragment>
            <PageHeading label="Kho sách">
                ...
                <Menu as={'div'} className={'relative'}>
                    <Menu.Button as={'button'} className='m-btn gap-1 bg-indigo-500 text-white hover:bg-indigo-600'>
                        <IoAdd size={16}/>
                    ...
                    >
                        <Menu.Items
                            className="absolute right-0 z-10 mt-2 w-80 max-w-screen origin-top-right rounded-lg overflow-hidden p-2.5 bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                            <div className="relative flex gap-2 flex-col bg-white">
