...
const IssuerEditBookSeriesPage: NextPageWithLayout<Props> = ({ data }) => {
          ...
          <div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
              <div className="sm:col-span-6">
                ...
                >
                  Tên Series<span className="text-rose-500">*</span>
                </label>
                <div className="mt-1">
                  <input
              ...
              <div className="sm:col-span-6">
                <label
                  ...
                  className="block text-sm font-medium text-gray-700"
                >
                  Mã Series<span className="text-rose-500">*</span>
                </label>
                <div className="mt-1">
                  <input
...
IssuerEditBookSeriesPage.getLayout = function getLayout(page: ReactElement) {
  return <AdminLayout>{page}</AdminLayout>;
};
export default IssuerEditBookSeriesPage;
