...
const IssuerCreateBookComboPage: NextPageWithLayout<Props> = ({ data }) => {
...
IssuerCreateBookComboPage.getLayout = function getLayout(page: ReactElement) {
  return <AdminLayout>{page}</AdminLayout>;
};
export default IssuerCreateBookComboPage;
