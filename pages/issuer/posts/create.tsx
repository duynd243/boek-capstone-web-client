...
const IssuerCreatePostPage: NextPageWithLayout = () => {
                ...
                <div className="pt-8 ">
                    <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                            ...
                            {form.errors.saleQuantity && form.touched.saleQuantity && (
                                <div className={"input-error"}>{form.errors.saleQuantity}</div>
                            )}
                        </div>
                    ...
                    <div>
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            {isLoading ? (
                                ...
                                books?.data?.map((book) => (
                                    <div key={book?.id} className={"flex sm:col-span-3"}>
                                        <Image
                                            width={200}
                                            height={300}
                                            src={book?.imageUrl || ""}
                                        ...
                                        <div>
                                            ...
                                            {/* discount according to selected book genre */}
                                            <div className="mt-2 flex items-center text-sm text-gray-500">
                                                <svg
                                                    className="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                {/* đang lấy api displayIndex, sách chưa có discount */}
                                                Giảm giá: {book?.category?.displayIndex || 0}%
                                            </div>
                                            <input
                                                onChange={(e) => {
                                                    // set state
