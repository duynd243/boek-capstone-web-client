...
import UpdateAuthorModal from "../../../components/Modal/UpdateAuthorModal";
              ...
              <div className="overflow-hidden border border-slate-200 shadow sm:rounded-lg">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tfoot>
                    <tr>
                      <td colSpan={2}>
                        <div className="flex flex-wrap items-center justify-between py-3 px-6 text-sm font-medium text-gray-700">
