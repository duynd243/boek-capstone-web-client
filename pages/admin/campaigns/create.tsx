...
import {storage} from "../../../services/initFirebase";
        ...
        <form className="mx-auto max-w-6xl space-y-8 divide-y divide-gray-200 bg-white p-10">
            <div className="space-y-8 divide-y divide-gray-200">
                ...
                <div className="pt-8">
                    ...
                    {/*    </fieldset>*/}
                    {/*</div>*/}
                    <p className='mt-1 text-sm text-gray-500'>Tinh chỉnh các thuộc tính nhằm tạo ra một tập khách hàng
                        phù hợp</p>
                            ...
                            <div className="mt-1">
                                ...
                                <div className='grid grid grid-cols-6 gap-x-4'>
                                    <input
                                        ...
                                        className="col-span-3 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                    />
                                    <input
                                        type="text"
                                        placeholder='Đến'
