...
const CustomerProductCard: React.FC<Props> = ({ product }) => {
                ...
                <div className="relative p-4">
                    ...
                    {product?.createdDate &&
                        <h2 className={"text-sm text-slate-600"}>
                            Đăng bán vào: {formatDistance(new Date(product?.createdDate), new Date(), {
                            addSuffix: true,
                            locale: vi,
                        })}
                        </h2>
                            ...
                            <div className="flex justify-end items-center gap-2">
                                ...
                                <p className="text-sm font-medium text-gray-500 line-through">
                                    {new Intl.NumberFormat("vi-VN", {
                                        style: "currency",
                                        currency: "VND",
                                    }).format((product?.salePrice || 0) + product?.discount * (product?.salePrice || 0) / 100 || 0)}
                                </p>
                            </div>
                            : null}
                        {/*Sale price*/}
