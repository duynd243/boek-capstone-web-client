    ...
    const form = useFormik(
        {
            ...
            validationSchema: Yup.object({
                code: Yup.string().required('Mã combo không được để trống'),
                ...
                selectedBooks: Yup.array().min(1, 'Combo phải có ít nhất 1 sách'),
            }),
            onSubmit: (values) => {
        ...
        <Fragment>
            <div className='bg-white border mx-auto max-w-6xl p-10'>
                ...
                <h1 className='text-2xl font-bold text-slate-800 md:text-3xl mb-6'>
                    {formMode === 'create' ? 'Thêm' : 'Sửa'} sách combo ✨
                </h1>

                <form onSubmit={form.handleSubmit}>

                    <Form.GroupLabel label={'Thông tin chung'} description={'Thông tin chung về combo sách'}/>
                    <div className='space-y-4 mt-3'>
                        <Form.Input placeholder={'VD: CB0001'}
                                    formikForm={form}
                                    required={true}
                                    fieldName={'code'}
                                    label={'Mã combo'}/>
                        <Form.Input placeholder={'VD: Cuốn Theo Chiều Gió (Trọn Bộ 2 Tập)'}
                                    formikForm={form}
                                    required={true}
                                    fieldName={'name'}
                                    label={'Tên combo (sách chủ đề)'}/>
                    ...
                    <Form.Divider/>
                    <Form.GroupLabel label={'Thể loại'} description='Thể loại chung của combo sách'/>
                    <div className='mt-3'>
                    ...
                    <Form.Divider/>
                    <Form.GroupLabel label={'Mô tả'} description='Mô tả về combo sách'/>
                    <div className='mt-3'>
                    ...
                    <Form.Divider/>
                    <Form.GroupLabel label={'Chọn sách'} description='Chọn những sách cùng thể loại cho combo'/>
                    <div className='mt-3'>
