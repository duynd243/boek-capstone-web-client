...
const SelectProfilePicture: React.FC<Props> = ({defaultImageURL, onChange}) => {

    const [selectedFile, setSelectedFile] = useState<File | null>(null);

    const initialPreviewURL = defaultImageURL || DefaultAvatar.src;
        ...
        <div className="flex items-center">
            ...
            <div className="ml-5 rounded-md shadow-sm">
                <div
                    ...
                    >
                        <span>
                            {selectedFile || defaultImageURL ? "Thay đổi" : "Tải lên"}
                        </span>
                    </label>
                    <input
