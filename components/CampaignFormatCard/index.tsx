...
const CampaignFormatCard: React.FC<Props> = ({
  ...
  return (
    <div className="relative h-full cursor-pointer select-none rounded border-2 border-slate-200 bg-white px-4 py-5 shadow-sm duration-150 ease-in-out ui-checked:border-indigo-400 hover:ui-not-checked:border-slate-300">
