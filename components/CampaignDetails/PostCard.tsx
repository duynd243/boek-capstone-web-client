...
import { IoCalendar, IoDocumentText, IoFileTray, IoLanguage, IoPerson, IoPricetag } from "react-icons/io5";
...
const PostCard: React.FC<Props> = ({ data }) => {
    ...
    return (
        <article
            className="group col-span-full overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm transition duration-300 hover:shadow-md sm:col-span-6">
                    ...
                    <div className="grow">
                        ...
                        <header className="mb-3 flex items-center">
                            <Image
                                ...
                                height={100}
                                src={
                                    data?.campaignBooks[0]?.participation?.issuer?.imageUrl ||
                                    DefaultAvatar.src
                                }
                                alt={""}
                            />
                  ...
                  <span className="font-semibold text-blue-700">
                    ...
                    {data?.createdDate
                        ...
                        <div className="mb-4 flex flex-wrap items-center justify-between">
                            ...
                            <div>
                                <div
                                    className="inline-flex rounded-full bg-emerald-100 px-2.5 py-0.5 text-center text-base font-semibold text-emerald-600">
                        ...
                        <ul className="mb-5 space-y-2 text-sm">
                            <FeaturedItem>
                                ...
                                <div>Xuất bản bởi {book?.publisher?.name || "N/A"}</div>
                            </FeaturedItem>
                            <FeaturedItem>
                            ...
                            <FeaturedItem>
                                ...
                                <div>Thể loại: {book?.category?.name || "N/A"}</div>
                            </FeaturedItem>
                            <FeaturedItem>
                            ...
                            <FeaturedItem>
                                ...
                                <div>Xuất bản năm {book?.releasedYear || "N/A"}</div>
                            </FeaturedItem>
                        </ul>
                    </div>
                    {/* Card footer */}
